...
class _SelectFieldState<T> extends State<SelectField<T>> {
  ...
  Widget build(BuildContext context) {
    ...
    final defaultBorder = widget.border ?? BorderSide.none,
        disabledBorder = widget.borderDisabled ?? BorderSide.none,
        errorBorder = widget.borderError ??
            BorderSide(color: Theme.of(context).colorScheme.error),
        focusedBorder = widget.borderFocused ?? BorderSide.none;
      ...
      child: Container(
        ...
        child: DropdownButtonFormField2<T>(
          ...
          iconStyleData: IconStyleData(
            ...
            openMenuIcon: widget.closedIcon ??
