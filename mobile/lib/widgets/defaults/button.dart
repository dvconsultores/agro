...
class Button extends StatelessWidget {
  const Button({
    ...
    this.boxShadow = const [Vars.boxShadow2, Vars.boxShadow3],
    this.color,
    this.bgColor,
  ...
  static Button variant({
    ...
    BorderRadius borderRadius =
        const BorderRadius.all(Radius.circular(Vars.radius8)),
  ...
  static Button textVariant({
    ...
    return Button(
      ...
      splashFactory: splashFactory,
      overlayColor: overlayColor ?? colors.label.withOpacity(.4),
      padding: padding,
      margin: margin,
      leading: leading,
      trailing: trailing,
  ...
  static Button iconVariant({
    ...
    BorderRadius borderRadius =
        const BorderRadius.all(Radius.circular(Vars.radius8)),
    BorderSide? borderSide,
    List<BoxShadow> boxShadow = const [Vars.boxShadow2, Vars.boxShadow3],
    Color? color,
    Color? bgColor,
    Color? bgColorDisabled,
    InteractiveInkFeatureFactory? splashFactory,
