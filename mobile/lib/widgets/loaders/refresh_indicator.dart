...
import 'package:sap_avicola/painters/sky_painter.dart';
import 'package:sap_avicola/painters/triangule_painter.dart';
  ...
  static Widget liquid({
    ...
    int springAnimationDurationInMilliseconds = 1000,
      ...
      liq.LiquidPullToRefresh(
        ...
        color: color ?? ThemeApp.colors(null).primaryDarken,
        height: height,
