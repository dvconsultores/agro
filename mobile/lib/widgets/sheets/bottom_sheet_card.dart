...
import 'package:sap_avicola/painters/draggable_frame_painter.dart';
      ...
      shape: shape ??
          const RoundedRectangleBorder(
            borderRadius: BorderRadius.only(
              topLeft: Radius.circular(Vars.radius28),
              topRight: Radius.circular(Vars.radius28),
            ),
          ),
      builder: builder ??
                ...
                suffixIcon: Row(
                    ...
                    children: [
                      ...
                      Icon(
                        ...
                        size: 24,
                        color: ThemeApp.colors(null).primary,
                      ),
