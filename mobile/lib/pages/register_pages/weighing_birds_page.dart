...
class WeighingBirdsPage extends StatefulWidget {
  const WeighingBirdsPage({
    super.key,
  ...
  @override
  State<WeighingBirdsPage> createState() => _WeighingBirdsPageState();
}

class _WeighingBirdsPageState extends State<WeighingBirdsPage>
    with ThemesMixin {
  ...
  final cantidadMuestreoController = TextEditingController();
  ...
  Future<void> guardar() async {
    final data = {
      ...
      "cantidad": cantidadMuestreoController.text,
      "peso_prom": pesoPromedioController.text,
    ...
    switch (widget.option) {
      case RegisterOption.breedingProcess:
        await apiLiderPollo.setPesaje(data, "CRIA");
        break;
      case RegisterOption.productionProcess:
        await apiLiderPollo.setPesaje(data, "PRODUCCION");
        break;
      case RegisterOption.fatteningProcess:
        await apiLiderPollo.setPesaje(data, "ENGORDE");
        break;
      case RegisterOption():
      ...
      body: Form(
        ...
        child: SingleChildScrollView(
          ...
          child: Column(children: [
            ...
            Gap(16.sp).column,
            InputField(
              controller: cantidadMuestreoController,
              autovalidateMode: AutovalidateMode.onUserInteraction,
              validator: (value) => ValidatorField.evaluate(
                  value, (instance) => [instance.required]),
              labelText: "Cant. Muestreo de Aves",
              hintText: "0",
