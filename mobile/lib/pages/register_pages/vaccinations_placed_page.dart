...
class VaccinationsPlacedPage extends StatefulWidget {
  const VaccinationsPlacedPage({
    super.key,
  ...
  @override
  State<VaccinationsPlacedPage> createState() => _VaccinationsPlacedPageState();
}

class _VaccinationsPlacedPageState extends State<VaccinationsPlacedPage>
    with ThemesMixin {
  ...
  var farms = <GranjaModel>[],
      ...
      vaccinationTypes = <VacunaModel>[];

  Future<void> getData() async {
    try {
      loader.init();
      await Future.wait([getGranjas(), getVacunas()]);
      loader.close();
    } catch (e) {
      loader.close();
    }
  ...
  Future<void> guardar() async {
    ...
    switch (widget.option) {
      case RegisterOption.breedingProcess:
        await apiLiderPollo.setVacuna(data, "CRIA");
        break;
      case RegisterOption.productionProcess:
        await apiLiderPollo.setVacuna(data, "PRODUCCION");
        break;
      case RegisterOption.fatteningProcess:
        await apiLiderPollo.setVacuna(data, "ENGORDE");
        break;
      case RegisterOption():
  ...
  Future<void> registerHandler() async {
    ...
    final accepts = await Modal.showAlertToContinue(
      ...
      titleText: "¿Deseas guardar el registro de Vacunas?",
    ...
    try {
      ...
      Nav.pushReplacement(context,
          ...
          page: OperationStatePage(
            ...
            descText: "El registro de vacuna fue guardado con éxito",
            actions: (context) => [
              Button(
        ...
        child: SingleChildScrollView(
          ...
          child: Column(children: [
            ...
            BottomSelectField(
              ...
              dropdownMaxChildSize: .7,
              dropdownInitialChildSize: .7,
              dropdownTitleText: "Tipo de Vacuna",
              dropdownSearchLabelText: "Tipo de Vacuna",
              dropdownSearchHintText: "Buscar Vacuna",
              dropdownSearchFunction: (index, item, search) =>
                  vaccinationTypes[index]
                      .name
                      .toLowerCase()
                      .contains(search.toLowerCase()),
            ),
