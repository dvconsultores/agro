<template>
  ...
  <div :id="idStylePage">
    <h5 class="text-primary w600 mb-6 mt-3" style="--fs: 22px">Registros Alimento</h5>
...
<script setup>
import '@/assets/styles/pages/process-birds/food-records.scss'
...
headers = [
  ...
  { title: "Orden transferencia", key: "orden", align: "center" },
  { title: "Codigo Alimento", key: "codigoAlimento", align: "center" },
  { title: "Cantidad", key: "cantidad", align: "center" },
  { title: "Granja", key: "granja", align: "center" },
  { title: "Fecha", key: "fecha", align: "center" },
  { title: "Fecha transferencia", key: "fechaTransferencia", align: "center" },
...
async function getItemsTabla(data = {
  ...
  try {
    ...
    const response = await ApiLiderPollo.granjas.getResgistrosAlimento(data)
    ...
    itemsTable.value = response[0].map((item) => ({
      id: item.id,
      lote: item.lote,
      idRecepcion: data.etapa == "PRODUCCION" ? item.lote_id?.id : item.recepcion_id?.id,
      orden: item.orden_transferencia_id?.num_orden,
      codigoAlimento: item.codigo_alimento,
      cantidad: item.cantidad,
      granja: item.granja_id?.name,
      fecha: moment(item.fecha).format('DD/MM/YYYY'),
      fechaTransferencia: moment(item.fecha_transferencia).format('DD/MM/YYYY'),
    ...
    {
      "id": 3,
      "fecha": "2024-10-18T00:00:00.000Z",
      "fecha_transferencia": "2024-10-18T00:00:00.000Z",
      "tipo_alimento": "ENGORDE POLLO ENGORDE GRANULADO FASE 2",
      "codigo_alimento": "000000000000105025",
      "cantidad": 1000,
      "lote": "Lote 0147-1",
      "creation_date": "2024-10-18T12:35:40.116Z",
      "recepcion_id": {
        "id": 4,
        "lote": "Lote 0147-1"
      },
      ...
      "orden_transferencia_id": {
        "id": 9703,
        "id_sap": "4900194000-4500011833-000000000000105025",
        "num_orden": "4500011833",
        "cantidad_kg": 3840,
        "disponible_kg": 3840,
        "codigo_alimento": "000000000000105025",
        "tipo_alimento": "ENGORDE POLLO ENGORDE GRANULADO FASE 2",
