...
subtitlePage = "Clasificaciones de huevos",
toast = useToast(),
currentTab = ref(0),
showTable = ref(true),
...
headers = [
  ...
  { title: "Usuario clasificación", key: "user", align: "center" },
  { title: "Fecha clasificacion", key: "fechaClasificacion", align: "center" },
  { title: "Cabtidad fertiles", key: "cantFertiles", align: "center" },
  { title: "Cabtidad infertiles", key: "cantInfertiles", align: "center" },
  { title: "Cabtidad sucios", key: "cantSucios", align: "center" },
  { title: "Cabtidad descartados", key: "cantDescartados", align: "center" },
...
async function getItemsTabla(data = {
  ...
  try {
    ...
    data.status = ['CLASIFICADO', 'AGENDADO', 'ASIGNADO', 'ENVIADO', 'CERRADO'];

    loadingTable.value = true;

    const response = await ApiLiderPollo.incubadora.getRecepciones(data)
    ...
    tablaItems.value = response[0].map((item) => ({
      ...
      lote: item.lote,
      estatus: item.status,
      user: `${item.user_clasificacion.user_name} - ${item.user_clasificacion.nombre} ${item.user_clasificacion.apellido}`,
      fechaClasificacion: new Date(item.fecha_clasificacion).toLocaleDateString(),
      cantFertiles: item.cant_fertiles,
      cantInfertiles: item.cant_infertiles,
      cantSucios: item.cant_sucios,
      cantDescartados: item.cant_descartados,
      pesoProm: item.peso_prom_grs,
    }));
  ...
  [
    ...
    "cant_recibido": 5000,
    "temp_huevos": 12,
    "placa_transporte": "123",
    "fecha_recepcion": "2024-10-16T00:00:00.000Z",
    "status": "CLASIFICADO",
    "fecha_clasificacion": "2024-10-16T00:00:00.000Z",
    "cant_fertiles": 4930,
    "cant_sucios": 1,
    "cant_infertiles": 9,
    "cant_descartados": 60,
    "peso_prom_grs": 100,
    "disponibles": null,
    "creation_date": "2024-10-16T15:33:22.826Z",
    "user_creacion": {
        "id": 4,
        "user_name": "test",
        "nombre": "test",
    ...
    "transporte_entrega_id": {
        "id": 255,
        "id_sap": "0000100399",
        "name": "4W LOGISTICA INDUSTRIAL CA"
    }
  }]
    */
