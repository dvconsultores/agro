<template>
  ...
  <div :id="idStylePage">
    <h5 class="text-primary w600 mb-6 mt-3" style="--fs: 22px">Registros Vacuna</h5>
...
<script setup>
import '@/assets/styles/pages/process-birds/vaccination-records.scss'
...
idStylePage = "vaccination-records",
...
headers = [
  ...
  { title: "Tipo vacuna", key: "tipoVacuna", align: "center" },
  { title: "Observación", key: "observacion", align: "center" },
...
async function getItemsTabla(data = {
  ...
  try {
    ...
    const response = await ApiLiderPollo.granjas.getResgistrosVacunas(data)
    ...
    itemsTable.value = response[0].map((item) => ({
      ...
      tipoVacuna: item.tipo_vacuna_id.nombre,
    ...
    [
    {
      ...
      "observaciones": "aplicación vacunas lote 5",
      "creation_date": "2024-10-03T14:51:20.023Z",
      "recepcion_id": {
        "id": 12,
        "lote": "Lote5"
      },
