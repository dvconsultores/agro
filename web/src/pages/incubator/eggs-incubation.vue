...
subtitlePage = "Incubaciones de huevos",
toast = useToast(),
currentTab = ref(0),
showTable = ref(true),
loadingRegister = ref(false),
headers = [
  { title: "Id incubacion", key: "id", align: "center" },
  ...
  { title: "Cabtidad huevos", key: "cantHuevos", align: "center" },
  { title: "Temperatura", key: "temperatura", align: "center" },
  { title: "Fecha Incubación", key: "fechaIncubacion", align: "center" },
  { title: "Fecha inicio Incubación", key: "fechaInicioIncubacion", align: "center" },
  { title: "Hora inicio incubacion", key: "horaIncubacion", align: "center" },
...
async function getItemsTabla(data = {
  ...
  try {
    ...
    const response = await ApiLiderPollo.incubadora.getIncubaciones(data)
    ...
    tablaItems.value = response[0].map((item) => ({
      ...
      cantHuevos: item.cant_huevos,
      temperatura: item.temperatura,
      fechaIncubacion: new Date(item.fecha_incubacion).toLocaleDateString(),
      fechaInicioIncubacion: new Date(item.fecha_inicio_incubacion).toLocaleDateString(),
      horaIncubacion: item.hora_inicio_incubacion,
    }));
