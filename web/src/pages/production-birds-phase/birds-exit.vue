<template>
  ...
  <div :id="idStylePage">
    ...
    <birds-exit :etapa="etapa" />

  </div>
</template>

<script setup>
import '@/assets/styles/pages/reproduction-breeding-phase/birds-exit.scss'
...
idStylePage = "birds-exit",
pageTitle = "Salida aves",
pageSubtitle = "Salida aves producción",
toast = useToast()
